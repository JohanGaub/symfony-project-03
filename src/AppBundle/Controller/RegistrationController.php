...
class RegistrationController extends Controller
{
    ...
    public function editShow(Request $request, User $user)
    {
        ...
        return $this->render('@App/Pages/modify_register.html.twig', array(
            'user' => $user,
    ...
    public function RegisterAssociateAction(Request $request)
    {
        ...
        return $this->render(
            '@App/Pages/add_associate_user.html.twig',
    ...
    public function showAssociate($page = 1)
    {
       ...
       /* $users_count = $userProfile->countUserTotal();
        ...
        return $this->render('@App/Pages/show_associate.html.twig', array(
            'User' => $userProfile,
            /*'pagination' => $pagination,*/
        ));
    }
